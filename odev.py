...
class InsuranceApp:
    ...
    def setup_ui(self):
        ...
        ttk.Button(btn_frame, text="+ PDF EKLE", style="Accent.TButton", command=self.add_from_pdf).pack(side='left', padx=(0, 15))
        ttk.Button(btn_frame, text="DÜZENLE", command=self.edit_selected).pack(side='left', padx=15)
        ...
        search_frame = tk.Frame(btn_frame, bg="#FAFAFA")
